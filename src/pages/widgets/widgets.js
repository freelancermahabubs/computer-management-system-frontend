...
function Widgets() {
  ...
  function renderChart() {
    ...
    if (chartContainer) {
      chartContainer.innerHTML =
        '<canvas id="widgetBarChart" className="w-100" height="190"></canvas>';
  ...
  useEffect(() => {
    fetch("/assets/data/widgets/widget-code-1.json")
    ...
    fetch("/assets/data/widgets/widget-code-2.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-3.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-4.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-5.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-6.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-7.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-8.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-9.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-10.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/widgets/widget-code-11.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
            ...
            <div className="col-xl-9">
              ...
              <div id="cardWidget" className="mb-5">
                ...
                <p>
                  ...
                  <code>.card-img-overlay</code> and <code>.d-flex</code>{" "}
                  utilities.
                </p>
                <Card>
                  <CardBody>
                      ...
                      <div className="col-xl-8">
                        <Card className="p-5px" data-bs-theme="light">
                          <div
                            ...
                            <img
                              src="assets/img/gallery/widget-cover-1.jpg"
                              alt=""
                              className="card-img"
                            />
                          </div>
                          <div
                            className="card-img-overlay d-flex flex-column bg-gray-700 bg-opacity-75 m-5px z-2"
                            data-bs-theme="dark">
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div className="dropdown dropdown-icon ms-auto">
                                  ...
                                  <div
                                    ...
                                    data-bs-theme="light">
                                    <a
                                      href="//www.youtube.com/watch?v=_AS5nu4u1ss"
                            ...
                            <div>
                              <a
                                href="//www.youtube.com/watch?v=_AS5nu4u1ss"
                                data-lity
                                className="text-inverse text-decoration-none d-flex align-items-center">
              ...
              <div id="listWidget" className="mb-5">
                ...
                <p>
                  ...
                  <code>.list-group</code> component with <code>.d-flex</code>{" "}
                  and hud utilities css classes.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                      <div className="col-xl-6">
                        <div className="text-inverse text-opacity-50 small mb-2">
                          <b>WITH ICON</b>
                        </div>
                        ...
                        <div className="list-group mb-3">
                          <a
                            href="#/"
                            className="list-group-item list-group-item-action d-flex align-items-center text-inverse">
              ...
              <div id="statsWidget" className="mb-5">
                <h4>Stats widget</h4>
                <p>
                  States widget is created by using Bootstrap <code>.card</code>{" "}
                  component with <code>.d-flex</code> and{" "}
                  <code>background-color</code> utilities.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
              ...
              <div id="chartWidget" className="mb-5">
                <h4>Chart widget</h4>
                <p>
                  Chart widget created by using Bootstrap <code>.card</code> and{" "}
                  <code>.list-group</code> component combined with Chart.js
                  plugins.
                </p>
                <Card>
                  <CardBody>
                      ...
                      <div className="col-xl-8">
                        <Card>
                          <CardBody className="text-inverse text-center">
                            <div className="fs-16px fw-bold">
                              Weekly Web Analytics
                            </div>
                            <div className="fs-13px mb-3 text-inverse text-opacity-50">
                              Week 11 May - 17 May
                            </div>
              ...
              <div id="userListWidget" className="mb-5">
                ...
                <p>
                  User list widget used to display people who participate in a
                  project or a group.
                </p>
                <Card>
                  <CardBody>
                    <div className="widget-user-list">
                      <div className="widget-user-list-item">
                        <a href="#/" className="widget-user-list-link">
                      ...
                      <div className="widget-user-list-item">
                        <a
                          href="#/"
                          className="widget-user-list-link bg-gray-200 text-gray-500 fs-12px fw-bold">
                          +26
                        </a>
                      </div>
                    </div>
              ...
              <div id="mapWidget" className="mb-5">
                <h4>Map widget</h4>
                <p>
                  Map widget created with Bootstrap <code>.card</code> and{" "}
                  <code>.list-group</code> component twitted with helper css
                  classes.
                </p>
                <Card>
                  <CardBody>
                      ...
                      <div className="col-xl-8">
                        <Card>
                          <div className="m-1 bg-inverse bg-opacity-10">
                            ...
                            <iframe
                              title="Youtube"
                              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d960.5886473867613!2d-122.41743634015282!3d37.776451983493104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter+HQ!5e0!3m2!1sen!2s!4v1495935122933"
                              style={{
                                border: 0,
                                width: "100%",
                                height: "10rem",
              ...
              <div id="chatWidget" className="mb-5">
                <h4>Chat widget</h4>
                <p>
                  Chat widget created by using Bootstrap <code>.card</code>{" "}
                          ...
                          <CardBody className="bg-inverse bg-opacity-10 p-0">
                            <PerfectScrollbar className="h-200px p-3">
                              <div className="widget-chat">
                                ...
                                <div className="widget-chat-date">
                                  Today 14:21
                                </div>
                                <div className="widget-chat-item">
                                  <div className="widget-chat-media">
                                ...
                                <div className="widget-chat-item">
                                  ...
                                  <div className="widget-chat-content">
                                    ...
                                    <div className="widget-chat-message">
                                      Not much, It's got a new look, contact
                                      pics show up in group messaging, some
                                      other small stuff.
                                    </div>
                                    <div className="widget-chat-message last">
              ...
              <div id="profileWidget" className="mb-5">
                ...
                <p>
                  Profile widget created by using Bootstrap <code>.card</code>{" "}
              ...
              <div id="productWidget" className="mb-5">
                ...
                <p>
                  Product widget created by using Bootstrap{" "}
                  <code>.list-group</code> component with <code>.d-flex</code>{" "}
                  utilities.
                </p>
                <Card>
              ...
              <div id="reminderWidget" className="mb-5">
                ...
                <p>
                  Reminder widget used to create a simple calendar to notify the
                  user upcoming events or task.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
              ...
              <div id="imageListWidget" className="mb-5">
                ...
                <p>
                  Image list widget created by using Bootstrap{" "}
                  <code>.card</code> and <code>.list-group</code> component with{" "}
                  <code>.d-flex</code> utilities.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                              ...
                              <div className="widget-img-list-item">
                                <a
                                  ...
                                  <span
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url(/assets/img/gallery/gallery-31.jpg)",
                                    }}></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a
                                  ...
                                  <span
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url(/assets/img/gallery/gallery-32.jpg)",
                                    }}></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a
                                  ...
                                  <span
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url(/assets/img/gallery/gallery-33.jpg)",
                                    }}></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a
                                  ...
                                  <span
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url(/assets/img/gallery/gallery-34.jpg)",
                                    }}></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a
                                  ...
                                  <span
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url(/assets/img/gallery/gallery-35.jpg)",
                                    }}></span>
                                </a>
                              </div>
                            </div>
